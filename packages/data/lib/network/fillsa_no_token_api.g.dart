...
part of 'fillsa_no_token_api.dart';
...
class _FillsaNoTokenApi implements FillsaNoTokenApi {
  _FillsaNoTokenApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<PageResponseNoticeResponse>> getNotice({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<PageResponseNoticeResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            null,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PageResponseNoticeResponse _value;
    try {
      _value = PageResponseNoticeResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<HttpResponse<List<MonthlyQuoteResponse>>> getMonthlyQuotesNonMember(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<MonthlyQuoteResponse>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            null,
    ...
    late List<MonthlyQuoteResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                MonthlyQuoteResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
