...
import 'domain/repository/HomeRepository.dart' as _i351;
import 'domain/usecase/ge_daily_quote_usecase.dart' as _i27;
...
_i174.GetIt init(
  ...
  gh.lazySingleton<_i351.HomeRepository>(
  ...
  gh.lazySingleton<_i783.PostLikeUseCase>(
    () => _i783.PostLikeUseCase(gh<_i351.HomeRepository>()),
  );
  gh.lazySingleton<_i27.GetDailyQuoteUseCase>(
    () => _i27.GetDailyQuoteUseCase(gh<_i351.HomeRepository>()),
  );
  gh.lazySingleton<_i580.GetDailyNonMemberUseCase>(
    () => _i580.GetDailyNonMemberUseCase(gh<_i351.HomeRepository>()),
  );
  gh.lazySingleton<_i426.PostUploadImageUseCase>(
    () => _i426.PostUploadImageUseCase(gh<_i351.HomeRepository>()),
  );
